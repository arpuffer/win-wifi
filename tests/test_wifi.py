...
def test_profile():
    ...
    profile = Profile(
        ssid=ssid, authentication=authentication, encryption=encryption, password=password
    )
...
def test_add_del_profile_str():
    wifi = Wifi()
    profile = Profile(
        ssid="TEST NAME", authentication="WPA2PSK", encryption="AES", password="testpassphrase"
    )
